      ...
      {currentView === 'cover' && (
        <div style={{
          ...
          <div style={{
            ...
            backgroundImage: `url(${typeof process !== 'undefined' && process.env ? process.env.PUBLIC_URL : ''}/images/cover.png)`,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img 
                src={`${typeof process !== 'undefined' && process.env ? process.env.PUBLIC_URL : ''}/images/image${currentCardIndex + 1}${currentCardIndex + 1 === 49 ? '.png' : '.jpg'}`} 
